    ...
    if (itemImage != null) {
      ...
      .then(() => {
        ...
        .then((url) => {
            ...
            onAdd({ name: itemName, description: itemDescription, status:itemStatus, quantity: itemQuantity, imageurl: url, expiry: itemExpiry, index: itemIndex, prioritized: isPrioritized }); // Include prioritized field in the item data
            setItemName('');
            setItemDescription('');
            setItemQuantity('');
            setItemStatus('');
      ...
      if (!itemName.trim() || !itemDescription.trim() || !itemQuantity.trim()) return;
      onAdd({ name: itemName, description: itemDescription, status:itemStatus, quantity: itemQuantity, imageurl: '', expiry: itemExpiry, index: itemIndex, prioritized: isPrioritized }); // Include prioritized field in the item data
      setItemName('');
      setItemDescription('');
      setItemQuantity('');
      setItemStatus('');
